...
![](file:///Users/yujiangshui/Desktop/Device%20Mode%20Mobile%20Emulation%20-%20Google%20Chrome_files/emulation-drawer-UI-location.png)

提示：你也可以摁下快捷键 Esc 来打开这个。

在 device 面板，点击 Save as 然后命名一下即可。

![](file:///Users/yujiangshui/Desktop/Device%20Mode%20Mobile%20Emulation%20-%20Google%20Chrome_files/emulation-drawer-device.png)

现在你可以快速的从 device 预设下拉列表里选择你自定义的模拟设置。

提示：这个 emulation drawer 的功能与主要 device 模块界面上一样，增加了一些（media type 和 sensor 功能）。

## 模拟网络情况

面对移动端用户，在各种复杂的网络情况下优化你的网站性能是十分关键的。

Device 模块的 network 功能可以让你测试你站点在复杂多变网络下的状态，包括 Edge，3G，以及离线。从预设列表里面选择一种连接方式，就可以启用网络丢包（network throttling）和强制等待（latency manipulation）功能。

![image](file:///Users/yujiangshui/Desktop/Device%20Mode%20Mobile%20Emulation%20-%20Google%20Chrome_files/network-throttling.png)
...
启用 media queries 查看器，你可以点击视图左上角的 Media queries ![image](file:///Users/yujiangshui/Desktop/Device%20Mode%20Mobile%20Emulation%20-%20Google%20Chrome_files/icon-media-query.png) 图标。DevTools 会检测你样式表里面的 media queries 代码并且在上面标尺中用不同颜色条显示出来。

![image](file:///Users/yujiangshui/Desktop/Device%20Mode%20Mobile%20Emulation%20-%20Google%20Chrome_files/media-query-inspector-ruler.png)
...
![image](file:///Users/yujiangshui/Desktop/Device%20Mode%20Mobile%20Emulation%20-%20Google%20Chrome_files/reveal-source-code.png)

提示：当你使用 media query 查看器的时候，你可能并不需要每次都使用手机模拟器。不退出 device 模块而关掉手机模拟器，你可以点击 Reset all overrides ![image](file:///Users/yujiangshui/Desktop/Device%20Mode%20Mobile%20Emulation%20-%20Google%20Chrome_files/icon-reset-overrides.png) 图标然后刷新页面。

### 预览其他 media 类型的效果

Media query 查看器查看的目标是应用在屏幕上的 CSS。如果你想预览其他 media 类型的样式效果，例如 print，你可以在 Emulation 面板中的 media 设置。

通过点击浏览器视图右上角 More overrides ![image](file:///Users/yujiangshui/Desktop/Device%20Mode%20Mobile%20Emulation%20-%20Google%20Chrome_files/icon-open-emulator-drawer.png) 图标打开 DevTools Emulation 面板。然后选择 Media 选项。

![image](file:///Users/yujiangshui/Desktop/Device%20Mode%20Mobile%20Emulation%20-%20Google%20Chrome_files/emulation-drawer-media.png)
...
![image](file:///Users/yujiangshui/Desktop/Device%20Mode%20Mobile%20Emulation%20-%20Google%20Chrome_files/emulation-drawer-sensors.png)
...
提示：Try out the DevTools debugger in combination with touch emulation using this fingerpaint touch screen demo.

### 设置地理数据

区别于桌面电脑，移动端设备通常使用 GPS 硬件来检测方位。在 Device 模块，你可以使用 Geolocation API 来模拟地理坐标。

勾选 Emulate geolocation coordinates 复选框可以启用地理模拟器。

![image](file:///Users/yujiangshui/Desktop/Device%20Mode%20Mobile%20Emulation%20-%20Google%20Chrome_files/emulation-drawer-geolocation.png)
...
![image](file:///Users/yujiangshui/Desktop/Device%20Mode%20Mobile%20Emulation%20-%20Google%20Chrome_files/emulation-drawer-accelerometer.png)
